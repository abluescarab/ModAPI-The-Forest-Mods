    ...
    public class CheatMenuComponent : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            if (this.visible)
            {
                ...
                GUI.Box(new Rect(10, 10, 400, 490), "", GUI.skin.window);
                this.Tab = GUI.Toolbar(new Rect(10, 10, 400, 30), this.Tab, new GUIContent[] {
                ...
                if (Tab == 0)
                {
                    ...
                    GUI.Label(new Rect(20f, cY, 150f, 20f), "Fly mode:", labelStyle);
